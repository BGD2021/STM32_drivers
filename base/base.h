...
#define u16 uint16_t 
#define u8 uint8_t 
#define LED0(n) (n? HAL_GPIO_WritePin(LED0_GPIO_Port,LED0_Pin,GPIO_PIN_SET):HAL_GPIO_Write Pin(LED0_GPIO_Port,LED0_Pin,GPIO_PIN_RESET)) 
#define LED0_T (HAL_GPIO_TogglePin(LED0_GPIO_Port, LED0_Pin)) //IO电平翻转 
#define LED0_ON LED0(0) 
#define LED0_OFF LED0(1) 
#define LED1(n) (n? HAL_GPIO_WritePin(LED1_GPIO_Port,LED1_Pin,GPIO_PIN_SET):HAL_GPIO_Write Pin(LED1_GPIO_Port,LED1_Pin,GPIO_PIN_RESET)) 
...
//IO?地址映射 #define GPIOA_ODR_Addr (GPIOA_BASE+20) //0x40020014 
